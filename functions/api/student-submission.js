...
export async function onRequestGet({ request, env }) {
  ...
  return jsonResponse({
    submission: { id: row.id, type: row.type, projectName: row.project_name, data, feedback, submittedAt: row.submitted_at, feedbackAt: row.feedback_at, assignmentTitle: row.assignment_title },
  });
}
